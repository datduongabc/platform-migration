...
> **Note:** This is technically a *re-platform / rewrite* (different languages and frameworks), not a pure refactor. "Refactor" usually implies behavior-preserving changes within a stack; framing this as a migration sets the right expectations for risk and effort.
...
- No change to the auth *model* (same roles/permissions), only its implementation.
